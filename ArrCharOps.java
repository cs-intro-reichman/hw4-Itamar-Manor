...
public class ArrCharOps {
    ...
    public static char charAt(char[] arr, int index) {
        if (index >= arr.length || index < 0) {
            throw new IndexOutOfBoundsException("Index out of range of array");
        }
        return arr[index];
    }
    ...
    */
    ...
    public static char[] subArray(char[] arr, int beginIndex, int endIndex) {
        if (beginIndex < 0 || beginIndex >= arr.length || endIndex > arr.length) {
            throw new IndexOutOfBoundsException("Index out of range of array");
        }
        if (beginIndex >= endIndex) {
            throw new IllegalArgumentException("beginIndex must be larger than endIndex");
        }
